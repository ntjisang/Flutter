                    ...
                    GestureDetector(
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (_) => MaisonsPage(ville: "Dakar"),
                          ),
                        );
            ...
            GestureDetector(
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (_) => MaisonsPage(ville: "Thies"),
                    ),
                  );
                },
                    child: HouseCard(
          ...
          GestureDetector(
            onTap: () {
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (_) => MaisonsPage(ville: "LOUGA"),
                ),
              );
            },
            child: HouseCard(
          ...
          GestureDetector(
            onTap: () {
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (_) => MaisonsPage(ville: "Saint-Louis"),
                ),
              );
            },
            child: HouseCard(
          ...
          GestureDetector(
            onTap: () {
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (_) => MaisonsPage(ville: "KAOLACK"),
                ),
              );
            },
            child: HouseCard(
                    ...
                    GestureDetector(
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (_) => MaisonsPage(ville: "DIOURBEL"),
                          ),
                        );
                      },
                    child : HouseCard(
          ...
          GestureDetector(
            onTap: () {
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (_) => MaisonsPage(ville: "ZIGUINCHOR"),
                ),
              );
            },
            child: HouseCard(
          ...
          GestureDetector(
            onTap: () {
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (_) => MaisonsPage(ville: "KOLDA"),
                ),
              );
            },
            child: HouseCard(
          ...
          GestureDetector(
            onTap: () {
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (_) => MaisonsPage(ville: "TAMBACOUNDA"),
                ),
              );
            },
            child:
          ...
          GestureDetector(
            onTap: () {
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (_) => MaisonsPage(ville: "MATAM"),
                ),
              );
            },
            child:
          ...
          GestureDetector(
            onTap: () {
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (_) => MaisonsPage(ville: "KAFFRINE"),
                ),
              );
            },
            child:
          ...
          GestureDetector(
            onTap: () {
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (_) => MaisonsPage(ville: "KEDOUGOU"),
                ),
              );
            },
            child:
          ...
          GestureDetector(
            onTap: () {
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (_) => MaisonsPage(ville: "SEDHIOU"),
                ),
              );
            },
            child:
